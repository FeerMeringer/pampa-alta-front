...
export default function Contacto() {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = 'https://pampa-alta-back-1.onrender.com/contacts';
      ...
      <div className="contacto-container">
        <div className="contacto-info">
          ...
          <p className="contacto-parrafo">
            Completa el formulario y nos pondremos en contacto contigo para asesorarte sobre la
            mejor solución solar para tus necesidades.
          </p>
        </div>
